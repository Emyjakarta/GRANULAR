program particle_motion
  ...
  real :: dt, T, z0, v0, k, c, m, g, epsilon, mu
  ...
  call initialize_simulation(z, v, time_array, z0, v0, dt, n_points)
  call run_simulation(z, v, time_array, F_g_array, F_contact_array, F_net_array, m, g, k, c, dt, epsilon, n_points, include_damping)
  call write_results(z, v, time_array, F_g_array, F_contact_array, F_net_array, n_points, "results_damping_F_net.txt")
  call generate_plot()  ! Save plot for elastic + damping case
  ...
  call initialize_simulation(z, v, time_array, z0, v0, dt, n_points)
  call run_simulation(z, v, time_array, F_g_array, F_contact_array, F_net_array, m, g, k, c, dt, epsilon, n_points, include_damping)
  call write_results(z, v, time_array, F_g_array, F_contact_array, F_net_array, n_points, "results_damping_F_net_vs_Time.txt")
  call generate_plot()  ! Save plot for elastic + damping case
  ...
  call initialize_simulation(z, v, time_array, z0, v0, dt, n_points)
  call run_simulation(z, v, time_array, F_g_array, F_contact_array, F_net_array, m, g, k, c, dt, epsilon, n_points, include_damping)
  call write_results(z, v, time_array, F_g_array, F_contact_array, F_net_array, n_points, "results_damping_F_contact.txt")
  call generate_plot()  ! Save plot for elastic + damping case
  ...
  call initialize_simulation(z, v, time_array, z0, v0, dt, n_points)
  call run_simulation(z, v, time_array, F_g_array, F_contact_array, F_net_array, m, g, k, c, dt, epsilon, n_points, include_damping)
  call write_results(z, v, time_array, F_g_array, F_contact_array, F_net_array, n_points, "results_damping_F_contact_vs_Time.txt")
  call generate_plot()  ! Save plot for elastic + damping case
  ...
  call initialize_simulation(z, v, time_array, z0, v0, dt, n_points)
  call run_simulation(z, v, time_array, F_g_array, F_contact_array, F_net_array, m, g, k, c, dt, epsilon, n_points, include_damping)
  call write_results(z, v, time_array, F_g_array, F_contact_array, F_net_array, n_points, "results_damping_F_g.txt")
  call generate_plot()  ! Save plot for elastic + damping case
